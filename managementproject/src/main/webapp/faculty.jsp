...
<%
facultynl nl=(facultynl)session.getAttribute("names");
String f=nl.getFirstname();
String l=nl.getLastname();
int i=nl.getId();
%>
    <header>
        <nav>
            <h1><%out.print(f); %> &nbsp;<%out.print(l); %></h1>
            <ul class="tabs">
    ...
    <main>
        <section class="pages">
            <div class="page is-active" id="admin" data-page="1">
                <h1>Faculty</h1>
                <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; View your data &nbsp;:&nbsp;&nbsp;<form action="fvdata"><input class="h" type="submit" value="Viewdata"></h3></form><br>
            </div>
            <div class="page" id="student" data-page="2">
               ...
               <h3> Insert student marks &nbsp;:&nbsp;&nbsp;<form action="fismarks"><input class="h" type="submit" value="Register"></h3></form><br>
               <h3> Insert student attendance &nbsp;:&nbsp;&nbsp;<form action="fisattend"><input class="h" type="submit" value="Register"></h3></form><br>
               <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; View students data &nbsp;:&nbsp;&nbsp;<form action="fsdata"><input class="h" type="submit" value="Viewdata"></h3></form><br>
